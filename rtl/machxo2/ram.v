...
/* Module Version: 6.5 */
/* /usr/local/diamond/3.8_x64/ispfpga/bin/lin64/scuba -w -n ram -lang verilog -synth synplify -bus_exp 7 -bb -arch xo2c00 -type bram -wp 10 -rp 0011 -rdata_width 8 -data_width 8 -num_rows 216 -cascade 11 -mem_init0  */
/* Mon Jan 16 19:01:03 2017 */
...
module ram (WrAddress, RdAddress, Data, WE, RdClock, RdClockEn, Reset, 
    ...
    defparam ram_0_0_0_0.CSDECODE_B = "0b000" ;
    ...
    DP8KC ram_0_0_0_0 (.DIA8(scuba_vlo), .DIA7(Data[7]), .DIA6(Data[6]), 
        ...
        .ADB12(scuba_vlo), .ADB11(scuba_vlo), .ADB10(RdAddress[7]), .ADB9(RdAddress[6]), 
        ...
        .DOA2(), .DOA1(), .DOA0(), .DOB8(), .DOB7(Q[7]), .DOB6(Q[6]), .DOB5(Q[5]), 
        .DOB4(Q[4]), .DOB3(Q[3]), .DOB2(Q[2]), .DOB1(Q[1]), .DOB0(Q[0]))
    ...
    // exemplar begin
    // exemplar attribute ram_0_0_0_0 MEM_LPC_FILE ram.lpc
    // exemplar attribute ram_0_0_0_0 MEM_INIT_FILE INIT_ALL_0s
    // exemplar end
